...
task tasks[N_TASKS] = { sendThrottlePacket, checkRFStatus, receiveTMPacket, handleTMPacket, readThrottle, checkButton, checkBattery, displayMode, setLEDs, setMotor, doServerWork, printStats };
